    ...
    <div className="resultSection">
      ...
      <div id="pagianationSection">
        <div id="pagiantionButtons">
          <div id="prevButton" className="nextAndPrevButton" onClick={()=>checkPagination(false)}>Previous</div>
          <div id="nextButton" className="nextAndPrevButton" onClick={()=>checkPagination(true)}>Next</div>
        </div>
